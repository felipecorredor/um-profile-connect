        ...
        >
          <div className="work-step-item">
            ...
            <div className="content">
              ...
              <p>
                Comienza tu viaje en unos pocos minutos. Completa el sencillo
                proceso de registro y obtén acceso a nuestra plataforma.
              </p>
            </div>
          </div>
          <div className="work-step-item">
            ...
            <div className="content">
              ...
              <p>
                Encuentra perfiles de estudiantes con habilidades excepcionales
                y antecedentes académicos destacados.
              </p>
            </div>
          </div>
          <div className="work-step-item">
